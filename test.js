        ...
        <ScrollView>
          <View style={styles.boks}>
            ...
            <TextInput
              ...
              value={newDOB}
              onChangeText={(newDOB) => {
                const parsedValue = parseInt(newDOB, 10); // parse input value as integer
                setnewDOB(parsedValue);
              }}
            />
            <TextInput
              style={{ fontSize: 20, paddingBottom: 5 }}
            ...
            <TextInput
              ...
              onChangeText={(newScore) => {
                const parsedValue = parseInt(newScore, 10); // parse input value as integer
                setnewScore(parsedValue); // set the state of newScore
              }}
            />
            <TextInput
              style={{ fontSize: 20, paddingBottom: 5 }}
            ...
            <View style={styles.modalForm}>
              ...
              <View style={{ flexDirection: "row", paddingTop: 5 }}>
                ...
                <TextInput
                  style={styles.modalInput}
                  keyboardType="numeric"
                  value={editingStudent.DOB ? editingStudent.DOB.toString() : ''}
                  onChangeText={(value) =>
                    setEditingStudent({
                      ...editingStudent,
                      DOB: parseInt(value),
              ...
              <View style={{ flexDirection: "row", paddingTop: 5 }}>
                ...
                <TextInput
                  style={styles.modalInput}
                  keyboardType="numeric"
                  value={editingStudent.Score ? editingStudent.Score.toString() : ''}
                  onChangeText={(value) =>
                    setEditingStudent({
                      ...editingStudent,
